...
release = version('gitchangelog').split("+")[0]
...
htmlhelp_basename = 'gitchangelogdoc'
...
latex_documents = [
    (master_doc, 'gitchangelog.tex', 'gitchangelog Documentation',
     [author], 'manual'),
]
...
man_pages = [
    (master_doc, 'gitchangelog', 'gitchangelog Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'gitchangelog', 'gitchangelog Documentation',
     [author], 'gitchangelog', description,
     'Miscellaneous'),
]
